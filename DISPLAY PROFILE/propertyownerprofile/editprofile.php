     ...
     <div class="container">
         ...
         <form action="" method="POST" enctype="multipart/form-data">
             ...
             <select name="status"  required>
                 <option value="Landlord" <?php echo ($user['status'] == 'Landlord') ? 'selected' : ''; ?>>Landlord</option>
                 <option value="Property Owner" <?php echo ($user['status'] == 'LProperty Owner') ? 'selected' : ''; ?>>Property Owner</option>
             </select>
